/// To fully implement this, when importing the environment package, build your `envFile` struct using the `#EnvFile` definition.
/// Then create a tool file in the same folder as your env implementation with the following function:
/// ```
...
///
/// See modeler/examples/env_example for a full implementation example.
